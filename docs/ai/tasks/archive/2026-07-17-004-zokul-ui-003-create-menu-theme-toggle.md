...
If implementation requires avatar viewer, settings, search, calls/video, backend APIs, new dependencies, or changes outside allowed files, stop and add `docs/ai/CHANGE_REQUESTS.md`.
