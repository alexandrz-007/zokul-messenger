...
If implementation requires touching files outside Allowed Files, changing behavior outside Scope, or adding any new feature/control, stop and add an entry to `docs/ai/CHANGE_REQUESTS.md`.
