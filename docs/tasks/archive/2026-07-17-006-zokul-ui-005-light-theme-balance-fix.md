...
Screenshot: `local screenshot reference`
...
If implementation requires touching files outside Allowed Files, changing behavior outside Scope, or adding any feature/control, stop and add `docs/CHANGE_REQUESTS.md`.
