...
Keep architecture maps in `docs/01_ARCHITECTURE_MAP.md` using Mermaid.
...
This keeps strategic decisions separate from implementation and allows different tools/models to cooperate through `docs`.
